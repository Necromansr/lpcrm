...
class Calendar extends Component {
    ...
    render() {
        return (
            ...
            {this.props.showColumn && <>         <input type="text" style={{ border: 'none', background: '#d4d4d4', padding: 0, height: 16, width: this.props.width, color: 'rgba(0, 0, 0, 0.5)', textAlign: 'center', border: " 1px solid white", fontWeight: 300, cursor: 'default', outline: 'none' }} readOnly value={this.state.stats[0].startDate !== null ? format(this.state.stats[0].startDate, 'dd.MM.yyyy') + '-' + format(this.state.stats[0].endDate, 'dd.MM.yyyy') : ''} />
