    ...
    render() {
        return (
            <div onMouseEnter={this.open} onMouseLeave={this.close}>
                <input type="text" style={{ border: 'none', background: '#d4d4d4', padding: 0, height: 16, width: 124, color: 'rgba(0, 0, 0, 0.5)', paddingLeft: 4, border: " 1px solid white" }} readOnly value={this.state.stats[0].startDate !== '' ? format(this.state.stats[0].startDate, 'dd.MM.yyyy') + '-' + format(this.state.stats[0].endDate, 'dd.MM.yyyy') : ''} />
