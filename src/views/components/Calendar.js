    ...
    render() {
        return (
            <div onMouseEnter={this.open} onMouseLeave={this.close}>
                <input type="text" style={{ border: 'none', background: '#d4d4d4', padding: 0, height: 16, width: '100%', color: 'rgba(0, 0, 0, 0.5)', paddingLeft: 10 }} readOnly value={format(this.state.stats[0].startDate, 'dd.MM.yyyy') + '-' + format(this.state.stats[0].endDate, 'dd.MM.yyyy')} />
