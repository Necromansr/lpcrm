                ...
                <div className="logo-pages-wrap">
                    ...
                    <div className="block-pages" style={{ pointerEvents: 'none' }}>
                        <div className="current-pages" style={this.props.count > 0 ? { top: 0 } : {}}>
                            ...
                            {console.log( this.props.zoom ,Math.floor(this.state.start + (Math.floor(document.body.clientHeight * 1.5 / (18 + 18 * this.props.zoom < 18 ? 18 : 18 + 18 * this.props.zoom)) * 0.59) - 1))}
