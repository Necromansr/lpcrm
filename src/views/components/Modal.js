    ...
    return (
        <>
            {((input === false && text !== '') || (input !== false)) && <>
                ...
                {(text !== '' && !wrapper) && <button className="gpsmetka-ttn" id="gpsmetka-ttn-2">
                ...
                <div className="input-backttn-block" onMouseEnter={e => setHover(true)} onMouseLeave={e => setHover(false)}>
                    ...
                    {(text !== '' && !wrapper) && <div className="back-ttn-block2">
                        <div className="backttntooltip">
                            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="status-ttn-info">Відправлення прямує до міста Богородчани.</div>
            </>}
        </>
    )
}
...
const DeliveryButton = ({ array, setArray, wrapper, setWrapper }) => {
    ...
    useEffect(() => {
        if (!wrapper) {
            ...
            setChange(false);
            if (keys.length > keys.filter(x => temp[x] !== '')?.length) {
                keys.forEach(x => {
                    if (x !== 'select') {
                        temp[x] = ''
                    }
    ...
    const AddressInput = ({ title, value, setList, id, setTop, setActive, classname }) => {

        const [show, setShow] = useState(false);
        const [text, setText] = useState(value)
        const onClick = (e) => {
            ChagneList(e.target, id)
        }

        return (
            <div className={"addres-delivery-list " + classname} onMouseEnter={e => setShow(true)} onMouseLeave={e => setShow(false)}><div>{title}:</div> <div className="underline-animation"><span className="underline" style={show ? { width: '100%' } : { width: 0 }}></span><input onClick={onClick} autoComplete="new-password" className="strana addres-delivery-input" type="text" value={text} onChange={e => setText(e.target.value)} /><b className="count-addres"></b></div></div>
        )
    }
    return (
        <>
            <div className="delivery-chose-btn" onMouseLeave={e => setHover(false)}>
                <button className="btn-delivery-department" onClick={e => {
                    ...
                    ChagneList(document.querySelector('.' + Object.keys((array.filter(x => x.select === true)[0].department?.select ? array.filter(x => x.select === true)[0].department : array.filter(x => x.select === true)[0].address) || {})[1]), Object.keys((array.filter(x => x.select === true)[0].department?.select ? array.filter(x => x.select === true)[0].department : array.filter(x => x.select === true)[0].address) || {})[1])
                ...
                <button className="btn-delivery-addres" onClick={e => {
            ...
            <div className="addres-delivery-block" style={wrapper && change ? { visibility: 'visible', opacity: 1, top: 25 } : {}}>
                <div className="addres-delivery-wrapper" >
                    {
                        Object.keys((array.filter(x => x.select === true)[0].department?.select ? array.filter(x => x.select === true)[0].department : array.filter(x => x.select === true)[0].address) || {}).map(x => {
                            if (x === 'city') {
                                return (
                                    <AddressInput classname={x} title={'Город'} id={x} setTop={setTop} setActive={setActive} setList={setList} value={(array.filter(x => x.select === true)[0].department?.select ? array.filter(x => x.select === true)[0].department : array.filter(x => x.select === true)[0].address)[x]} />
                                )
                            } else if (x === 'department') {
                                return (
                                    <AddressInput classname={x} title={'Отд-ние'} id={x} setTop={setTop} setActive={setActive} setList={setList} value={(array.filter(x => x.select === true)[0].department?.select ? array.filter(x => x.select === true)[0].department : array.filter(x => x.select === true)[0].address)[x]} />
                                )
                            } else if (x === 'country') {
                                return (
                                    <AddressInput classname={x} title={'Страна'} id={x} setTop={setTop} setActive={setActive} setList={setList} value={(array.filter(x => x.select === true)[0].department?.select ? array.filter(x => x.select === true)[0].department : array.filter(x => x.select === true)[0].address)[x]} />
                                )
                            } else if (x === 'street') {
                                return (
                                    <AddressInput classname={x} title={'Улица'} id={x} setTop={setTop} setActive={setActive} setList={setList} value={(array.filter(x => x.select === true)[0].department?.select ? array.filter(x => x.select === true)[0].department : array.filter(x => x.select === true)[0].address)[x]} />
                                )
                            } else if (x === 'house') {
                                return (
                                    <AddressInput classname={x} title={'Дом'} id={x} setTop={setTop} setActive={setActive} setList={setList} value={(array.filter(x => x.select === true)[0].department?.select ? array.filter(x => x.select === true)[0].department : array.filter(x => x.select === true)[0].address)[x]} />
                                )
                            } else if (x === 'apartment') {
                                return (
                                    <AddressInput classname={x} title={'Кв-ра'} id={x} setTop={setTop} setActive={setActive} setList={setList} value={(array.filter(x => x.select === true)[0].department?.select ? array.filter(x => x.select === true)[0].department : array.filter(x => x.select === true)[0].address)[x]} />
                                )
                            } else if (x === 'index') {
                                return (
                                    <AddressInput classname={x} title={'Индекс'} id={x} setTop={setTop} setActive={setActive} setList={setList} value={(array.filter(x => x.select === true)[0].department?.select ? array.filter(x => x.select === true)[0].department : array.filter(x => x.select === true)[0].address)[x]} />
                                )
                            }
                        })}
                </div>
                    ...
                    <SimpleBar style={{ maxHeight: 142 }}>
                        <div className='goroda'>
                            {list.map(x => <div onClick={e => {
                                ...
                                setArray(temp)
                                setActive(Object.keys((array.filter(x => x.select === true)[0].department?.select ? array.filter(x => x.select === true)[0].department : array.filter(x => x.select === true)[0].address) || {})[2])
                                ChagneList(document.querySelector('.' + Object.keys((array.filter(x => x.select === true)[0].department?.select ? array.filter(x => x.select === true)[0].department : array.filter(x => x.select === true)[0].address) || {})[2]), Object.keys((array.filter(x => x.select === true)[0].department?.select ? array.filter(x => x.select === true)[0].department : array.filter(x => x.select === true)[0].address) || {})[2])
                            }}>{x}</div>)}
                        </div>
                    </SimpleBar>
                </div>
    ...
    return (
        <div style={{ width: 163, height: 12 }} onMouseLeave={onMouseLeave}>
            ...
            <div className="info-data-block" style={hover ? { width: 155 } : { width: 0 }}>
                <span className="info-calen-data calen-data-accept" >14.01.2021</span><span className="info-calen-data-2 calen-data-accept-2">13:45:21</span><span className="info-calen-data-3 calen-data-accept-3"><b className="block-hours">00</b>:<b className="block-min">12</b>:<b className="block-sec">22</b><span className="color-time zelen"></span></span>
            </div>
        ...
        <div className="order orderModeOn" id="order">
            ...
            <div className="order-header">
                <div className="order-header-wrapper" onMouseEnter={headerMouseEnter} onMouseLeave={headerMouseLeave}>
                    ...
                    <div className="order-info-time" style={header ? { maxWidth: 200, marginLeft: 6 } : {}}><span>от 26.07.20</span><span>09:09:36</span><span className="info-time-open">00:23:00<span></span></span>
                    </div>
                </div>
            ...
            <div className="container">
                ...
                <div className="wrap-delivery-info-utm">
                    <table className="delivery-table">
                        <tr>
                            <td colSpan="2" className="contact-header"><span >Доставка</span></td>
                        </tr>
                        <tr>
                    ...
                    <table className="info-table">
                        <tr>
                            <td colSpan="2" className="contact-header"><span >Информация</span>
                            ...
                            <td className="info-description ip-block" style={hoverWireless ? { height: 43 } : {}}>
                                <div className="ip-wrapper" onMouseLeave={e => setHoverWireless(false)}>
                                    <div className="ip-block-wrapper" >
                                        <button className="ip-lock-btn tooltip-logo" onClick={e => { setLockAddress(!lockAddress); if (lockAddress && lockWireless) { setLockWireless(false) } }} onMouseEnter={e => setHoverWireless(true)}>
                                        ...
                                        <div className="info-ip"><span id="primary-ip">178.213.0.225</span>
                                        </div>
                                    ...
                                    <div className="ip-block-all-wrapper" style={hoverWireless ? { height: 17, paddingTop: 10 } : {}}>
                                        <button className="ip-lock-btn tooltip-logo-network" onClick={e => { setLockWireless(!lockWireless); if (!lockAddress && !lockWireless) { setLockAddress(true) } else if (lockAddress && !lockWireless) { setLockAddress(true) } else { setLockAddress(false) } }}>
                                        ...
                                        <div class="info-ip order-tooltip"><span id="another-ip">178.213.0.<b style={{ fontSize: 11, fontWeight: 300, textDecoration: 'underline' }}>X</b><b style={{ fontSize: 11, fontWeight: 300, textDecoration: 'underline' }}>X</b><b style={{ fontSize: 11, fontWeight: 300, textDecoration: 'underline' }}>X</b></span>
                                        </div>
                                        <div className="ip-icons-position">
                                            <span className="flags ua button-tooltip">🇺🇦</span>
                                            <img className="wifi-icon button-tooltip" src={wifi} alt="" />
                                        </div>
                                    </div>
                                </div>
                            </td>
                    ...
                    <div className="utm-wrapper">
                        <table className="utm-table">
                            <tr>
                                <td className="contact-header utm-header">UTM - метки</td>
                            </tr>
                        </table>
                        <div className="utm-block" >
                            <SimpleBar style={{ maxHeight: 115 }}>
                                ...
                                <table className="">
                                    <tbody>
                                        <tr>
                                            <td className="utm-list"><span >Source:</span></td>
                                        ...
                                        <tr>
                                            <td className="utm-list"><span >Medium:</span></td>
                                            <td className="utm-description" onMouseEnter={e => {
                                                timer = setTimeout(() => {
                                                    if (e.target.scrollWidth > e.target.offsetWidth) {
                                        ...
                                        <tr>
                                            <td className="utm-list"><span >Term:</span></td>
                                            <td className="utm-description" onMouseEnter={e => {
                                                timer = setTimeout(() => {
                                                    if (e.target.scrollWidth > e.target.offsetWidth) {
                                        ...
                                        <tr>
                                            <td className="utm-list"><span >Content:</span></td>
                                            <td className="utm-description" onMouseEnter={e => {
                                                timer = setTimeout(() => {
                                                    if (e.target.scrollWidth > e.target.offsetWidth) {
                                        ...
                                        <tr>
                                            <td className="utm-list"><span >Campaign:</span></td>
                                            <td className="utm-description" onMouseEnter={e => {
                                                timer = setTimeout(() => {
                                                    if (e.target.scrollWidth > e.target.offsetWidth) {
                        ...
                        <table className="dop-sale-table">
                            ...
                            <tfoot className="dop-product-table-tfoot">
                                {additionally && <><tr>
                                    ...
                                    <tr>
                                        <td colSpan="5"></td>
                                        <td><span className="sum-number">0</span></td>
                                        <td>
                                            <span className="sum-all product-number-format">0.00</span>
                                        </td>
                                        <td></td>
                                    </tr> </>}
                            </tfoot>
