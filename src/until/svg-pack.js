import SvgLogoNV from '../views/assets/icons/logo_NP.svg';
import crmLogo from '../views/assets/icons/crm.svg';
import promLogo from '../views/assets/icons/Prom.svg';
import rozetkaLogo from '../views/assets/icons/Rozetka.svg';
import videoregistrator from '../views/assets/icons/videoregistrator.jpg';
import kalyan from '../views/assets/icons/image19.png';
import addImg from '../views/assets/icons/circleplus.svg';
...
const SvgCalendar = () => {
	return (
		...
		>
			...
			></path>
			<path
				d="M10.75 7.49971C11.109 7.49971 11.4 7.20869 11.4 6.84971C11.4 6.49072 11.109 6.19971 10.75 6.19971C10.3911 6.19971 10.1 6.49072 10.1 6.84971C10.1 7.20869 10.3911 7.49971 10.75 7.49971Z"
				fill="#4D4D4D"
			></path>
			<path
				d="M7.49998 7.49971C7.85896 7.49971 8.14998 7.20869 8.14998 6.84971C8.14998 6.49072 7.85896 6.19971 7.49998 6.19971C7.14099 6.19971 6.84998 6.49072 6.84998 6.84971C6.84998 7.20869 7.14099 7.49971 7.49998 7.49971Z"
				fill="#4D4D4D"
			></path>
			<path
				d="M4.25004 10.7497C4.60902 10.7497 4.90004 10.4587 4.90004 10.0997C4.90004 9.74072 4.60902 9.44971 4.25004 9.44971C3.89105 9.44971 3.60004 9.74072 3.60004 10.0997C3.60004 10.4587 3.89105 10.7497 4.25004 10.7497Z"
				fill="#4D4D4D"
			></path>
			<path
				d="M10.75 10.7497C11.109 10.7497 11.4 10.4587 11.4 10.0997C11.4 9.74072 11.109 9.44971 10.75 9.44971C10.3911 9.44971 10.1 9.74072 10.1 10.0997C10.1 10.4587 10.3911 10.7497 10.75 10.7497Z"
				fill="#4D4D4D"
			></path>
			<path
				d="M7.49998 10.7497C7.85896 10.7497 8.14998 10.4587 8.14998 10.0997C8.14998 9.74072 7.85896 9.44971 7.49998 9.44971C7.14099 9.44971 6.84998 9.74072 6.84998 10.0997C6.84998 10.4587 7.14099 10.7497 7.49998 10.7497Z"
				fill="#4D4D4D"
			></path>
		</svg>
	)
